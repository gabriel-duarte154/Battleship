...
const setShipController = () => {
  ...
  const shipsObj = (0,_game_helpers_ships_mjs__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
const Game = () => {
  ...
  function setShips() {
    (0,_game_helpers_placeShips_mjs__WEBPACK_IMPORTED_MODULE_2__["default"])(player);

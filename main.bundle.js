...
const gameboard_controller = () => {
  ...
  async function attackEvent(position) {
    ...
    await delayEvent(1200)
      ...
      .then(() => {
        upadatePlayerBoard();
        _pubsub_evets_mjs__WEBPACK_IMPORTED_MODULE_0__["default"].emit('write', 'Awaiting orders...');
